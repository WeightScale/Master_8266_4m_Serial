...
#define TIMEOUT_HTTP 3000			/** ¬рем€ ожидани€ ответа HTTP запраса*/
#define STABLE_NUM_MAX 10			/**  оличество стабильных измерений*/
#define MAX_EVENTS 100				/**  оличество записей событий*/
...
typedef struct {
	...
	unsigned int seal;
	float zero_man_range;    			// 0,2,4,10,20,50,100% диапазон обнулени€
	float zero_on_range;     			// 0,2,4,10,20,50,100% диапазон обнулени€
